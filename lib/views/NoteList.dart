              ...
              itemBuilder: (_,index){
                return Dismissible(
                  ...
                  confirmDismiss: (direction) async {
                    ...
                    print(result);
                    if(result){
                      final deleteResult = await services.deleteNote(_apiResponse.data[index].noteId);
                      var message;
                  ...
                  child: ListTile(
                    ...
                    onTap: (){
                      ...
                      Navigator.push(context,MaterialPageRoute(builder: (_)=>NoteModify(noteId: _apiResponse.data[index].noteId,))).then((value){
                        _fetchNotes();
                      });
                    },
                  ),
